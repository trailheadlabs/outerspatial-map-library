...
var SwitcherControl = L.Control.extend({
  ...
  _initLayout: function () {
    var container = this._container = L.DomUtil.create('div', 'leaflet-bar leaflet-bar-single leaflet-control');
    ...
    this._active = L.DomUtil.create('div', 'outerspatial-control-switcher', container);
